    ...
    <footer className="bg-gray-900 text-gray-300 mt-12">
      <div className="container mx-auto py-10 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          ...
          <p className="text-sm mt-2">Tienda de repuestos - Proyecto demo</p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm mt-2">soporte@carshop.local</p>
          <p className="text-sm">(+54) 9 11 1234-5678</p>
        </div>
      </div>
      <div className="border-t border-gray-800 py-4 text-center text-sm">© {new Date().getFullYear()} Carshop - Demo</div>
    </footer>
  )
}

        ...
        <main className="flex-1 container mx-auto px-4 py-12">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6">
              ...
              {isAdmin && (
                <div className="mt-4 rounded-xl border border-orange-500/20 bg-orange-500/5 p-4">
                  <p className="text-sm font-semibold text-orange-400">👨‍💼 Panel de Administrador</p>
                  <p className="text-xs text-gray-500 mt-2 mb-3">Accesos rápidos a herramientas de administración</p>
                  <div className="mt-3 flex flex-col gap-2">
                    <Link href="/admin/pedidos" className="text-xs px-3 py-2 rounded-lg border border-orange-500/30 text-orange-300 bg-orange-500/10 hover:bg-orange-500/20 transition-colors">📦 Gestionar Pedidos</Link>
                    <Link href="/dashboard" className="text-xs px-3 py-2 rounded-lg border border-blue-500/30 text-blue-300 bg-blue-500/10 hover:bg-blue-500/20 transition-colors">📊 Dashboard Analytics</Link>
                    <Link href="/repuestos/new" className="text-xs px-3 py-2 rounded-lg border border-green-500/30 text-green-300 bg-green-500/10 hover:bg-green-500/20 transition-colors">➕ Nuevo Producto</Link>
                    <Link href="/categorias/new" className="text-xs px-3 py-2 rounded-lg border border-purple-500/30 text-purple-300 bg-purple-500/10 hover:bg-purple-500/20 transition-colors">📁 Nueva Categoría</Link>
                    <Link href="/cupones" className="text-xs px-3 py-2 rounded-lg border border-pink-500/30 text-pink-300 bg-pink-500/10 hover:bg-pink-500/20 transition-colors">🎟️ Gestionar Cupones</Link>
                  </div>
                </div>
              )}
            </div>
          ...
          {isAdmin && (
            <div className="mt-8 rounded-2xl border border-blue-500/20 bg-blue-500/5 p-6 text-center">
              <h2 className="text-xl font-bold text-blue-300 mb-2">📊 Área de Administración</h2>
              <p className="text-gray-400 mb-6">Las estadísticas detalladas y análisis de negocio están disponibles en el Dashboard</p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/admin/pedidos" className="px-6 py-2 rounded-lg bg-gradient-to-r from-orange-600 to-orange-500 text-white font-semibold hover:shadow-lg hover:shadow-orange-500/20 transition-all">
                  📦 Ir a Gestión de Pedidos
                </Link>
                <Link href="/dashboard" className="px-6 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold hover:shadow-lg hover:shadow-blue-500/20 transition-all">
                  📊 Ir a Dashboard
                </Link>
              </div>
            </div>
